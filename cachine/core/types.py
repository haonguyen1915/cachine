...
from typing import Any, Awaitable, Callable, Dict, List, Optional, Protocol, Tuple, TypeVar, runtime_checkable
...
class Cache(Protocol):
    ...
    # Enrichment
    def get_or_set(self, key: CacheKey, factory: Callable[[], T], *, ttl: Optional[int | timedelta] = None, jitter: Optional[int] = None) -> T: ...
...
class AsyncCache(Protocol):
    ...
    # Enrichment
    async def get_or_set(self, key: CacheKey, factory: Callable[[], Awaitable[T]] | Callable[[], T], *, ttl: Optional[int | timedelta] = None, jitter: Optional[int] = None) -> T: ...
